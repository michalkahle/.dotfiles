...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}\[\033[07;32m\]\w\$\[\033[00m\] '
else
...
source /home/michal/conda/etc/profile.d/conda.sh
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/michal/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/michal/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/michal/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
